...
-	Mở thư mục vừa clone trong Visual Studio Code: cd đến thư mục vite-project(thư mục chứa src)
-	Sau đó chạy lệnh : npm install (lệnh này sẽ tải về các thư viện React, tải Vite, tải Tailwind, Axios, React Router, v.v.
-	Sau đó chạy frontend: npm run dev
